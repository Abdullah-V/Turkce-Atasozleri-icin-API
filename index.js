...
"Fare deliğe sığmamış, bir de kuyruğuna kabak bağlamış: 1",
"2",
...
"Kızım sana söylüyorum (dedim) gelinim sen anla (işit): 1",
"2",
...
"Kuşa süt nasip olsa anasından olurdu: 1",
"2",
"uşkulu uyku evin bekçisidir",
"Kuşu kuşla avlarlar",
...
"Müflis (züğürtleyen) bezirgan (tüccar) eski defterlerini karıştırır: 1",
"2",
...
"Öpülecek el ısırılmaz", 
    ...
    "p":[
        ...
        "Paran gitti mi diye sormazlar, isin bitti mi diye sorarlar",
...
"Su küçüğün, söz (sofra, yemek) büyüğün: 1",
"2",
...
"Sütten ağzı yanan yoğurdu (ayranı) üfleyerek yer (içer)", 
    ...
    "ş":[
        ...
        "şimşek çakmadan gök gürlemez: 1",
        "2",
        "Şöhret afettir", 
    ],
    "t":[
...
"Tüccar züğürtleyince geçmiş defterleri yoklar: 1",
"2",
...
"Yâr (dost) beni ansın bir koz ile, o da çürük çıksın",
...
"Yatan (yatar) aslandan (kurttan), gezen (yeler) tilki yeğdir (iyidir):1.",
"2",
"Yatanın yürüyene borcu var: 1",
"2",
...
"Yazın başı pişenin, kışın aşı pişer: 1",
"2",
"Yazın çalışan, kışın gülüşür",
"Yazın gölge hoş, kışın çuval boş: 1",
"2",
...
"Züğürt bezirgân eski defterleri karıştırır (yoklar): 1",
"2",
...
app.post('/',async (req,res) => {
    ...
    console.log(splitted,letter,limit)
